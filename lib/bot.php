 ...
 *
 * @link https://github.com/radyakaze/Telebot
 *
 * @license GPL-3.0
 */
...
class Bot
{
    ...
    public static function send($action = 'sendMessage', $data = [])
    {
        ...
        $ch = curl_init();
        $options = [
            CURLOPT_URL => 'https://api.telegram.org/bot' . Telebot::$token . '/' . $action,
            CURLOPT_POST => true,
        ...
        if (Telebot::$debug && $action != 'getUpdates') {
